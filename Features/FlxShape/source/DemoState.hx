...
class DemoState extends FlxState
{
	...
	override public function create():Void
	{
		...
		cross = new FlxShapeCross(10, 190, 50, 25, 50, 25, 0.5, 0.5, {
			thickness: 8,
			color: FlxColor.RED,
		...
		cross2 = new FlxShapeCross(70, 190, 37.5, 12.5, 50, 12.5, 0.5, 0.25, {
			thickness: 4,
			color: FlxColor.GRAY,
			capsStyle: CapsStyle.SQUARE,
			jointStyle: JointStyle.MITER
		...
		var arrow_nw = new FlxShapeArrow(190, 130, new FlxPoint(50, 50), new FlxPoint(0, 0), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_n = new FlxShapeArrow(190 + 50, 130, new FlxPoint(0, 50), new FlxPoint(0, 0), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_ne = new FlxShapeArrow(190 + 50, 130, new FlxPoint(0, 50), new FlxPoint(50, 0), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_e = new FlxShapeArrow(190, 130 + 50, new FlxPoint(50, 0), new FlxPoint(0, 0), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_se = new FlxShapeArrow(190 + 50, 130 + 50, new FlxPoint(0, 0), new FlxPoint(50, 50), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_s = new FlxShapeArrow(190 + 50, 130 + 50, new FlxPoint(0, 0), new FlxPoint(0, 50), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_sw = new FlxShapeArrow(190, 130 + 50, new FlxPoint(50, 0), new FlxPoint(0, 50), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
		var arrow_w = new FlxShapeArrow(190 + 50, 130 + 50, new FlxPoint(0, 0), new FlxPoint(50, 0), 10.0, {thickness: 4, color: FlxColor.WHITE},
			{thickness: 6, color: FlxColor.BLUE});
