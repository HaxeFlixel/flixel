...
class FlxG 
{
	...
	{
		_game._step = Math.floor(1000 / Framerate);
	 ...
	 */
	static public function playMusic(Music:Class<Sound>, ?Volume:Float = 1.0):Void
	{
		if (music == null)
		{
			music = new FlxSound();
	 ...
	 */
	static public function loadSound(?EmbeddedSound:Class<Sound> = null, ?Volume:Float = 1.0, ?Looped:Bool = false, ?AutoDestroy:Bool = false, ?AutoPlay:Bool = false, ?URL:String = null):FlxSound
	{
	 ...
	 * @return	A <code>FlxSound</code> object.
	 */
	static public function play(EmbeddedSound:Class<Sound>, ?Volume:Float = 1.0, ?Looped:Bool = false, ?AutoDestroy:Bool = true):FlxSound
	{
