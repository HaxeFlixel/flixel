...
class Node
{
	...
	#if !flash
	public function addSpriteSheetFramesData(frameWidth:Int, frameHeight:Int, origin:Point = null, startX:Int = 0, startY:Int = 0, endX:Int = 0, endY:Int = 0, xSpacing:Int = 0, ySpacing:Int = 0):FlxSpriteFrames
	{
		if (endX == 0)
		{
			endX += item.width;
		...
		return atlas._tileSheetData.addSpriteSheetFramesData(frameWidth, frameHeight, origin, startX + this.x, startY + this.y, endX + this.x, endY + this.y, xSpacing, ySpacing);
	}
