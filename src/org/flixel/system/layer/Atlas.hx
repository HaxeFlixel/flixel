...
class Atlas
{
	 ...
	 */
<<<<<<< HEAD:flixel/system/layer/Atlas.hx
<<<<<<< HEAD:src/org/flixel/system/layer/Atlas.hx
=======
	 ...
	 */
>>>>>>> origin/dev:flixel/system/layer/Atlas.hx
=======
>>>>>>> experimental:src/org/flixel/system/layer/Atlas.hx
