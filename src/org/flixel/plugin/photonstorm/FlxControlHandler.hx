...
class FlxControlHandler
{
	...
	#end
	private var fireCallback:Dynamic;	// A function to call every time they fire
	...
	#end
	private var jumpCallback:Dynamic;	// A function to call every time they jump
	 ...
	 */
	#if flash
	public function setStandardSpeed(speed:UInt, ?acceleration:Bool = true):Void
	#else
	 ...
	 */
	#if flash
	public function setMaximumSpeed(xSpeed:UInt, ySpeed:UInt, ?limitVelocity:Bool = true):Void
	#else
	 ...
	 */
	#if flash
	public function setFireButton(key:String, keymode:UInt, repeatDelay:UInt, callbackFunc:Dynamic, ?altKey:String = ""):Void
	#else
	public function setFireButton(key:String, keymode:Int, repeatDelay:Int, callbackFunc:Dynamic, ?altKey:String = ""):Void
	#end
	{
		fireKey = key;
		fireKeyMode = keymode;
	 ...
	 */
	#if flash
	public function setJumpButton(key:String, keymode:UInt, height:Int, surface:Int, ?repeatDelay:UInt = 250, ?jumpFromFall:Int = 0, ?callbackFunc:Dynamic = null, ?altKey:String = ""):Void
	#else
	public function setJumpButton(key:String, keymode:Int, height:Int, surface:Int, ?repeatDelay:Int = 250, ?jumpFromFall:Int = 0, ?callbackFunc:Dynamic = null, ?altKey:String = ""):Void
	#end
	{
		jumpKey = key;
		jumpKeyMode = keymode;
