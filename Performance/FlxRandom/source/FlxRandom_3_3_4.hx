 ...
 * This class is from HaxeFlixel 3.3.4
 */
class FlxRandom_3_3_4
{
	/**
	...
	public static function color(Min:Int = 0, Max:Int = 255, Alpha:Int = 255, GreyScale:Bool = false):Int
	{
		...
		return FlxColor.fromRGB(_red, _green, _blue, Alpha);
	}
	 ...
	 */
	public static function colorExt(RedMinimum:Int = 0, RedMaximum:Int = 255, GreenMinimum:Int = 0, GreenMaximum:Int = 255, BlueMinimum:Int = 0,
			BlueMaximum:Int = 255, AlphaMinimum:Int = -1, AlphaMaximum:Int = -1):Int
	{
		if (RedMinimum < 0)
			RedMinimum = 0;
		if (RedMinimum > 255)
		...
		return FlxColor.fromRGB(_red, _green, _blue, _alpha);
	}
	 ...
	 */
	static inline function generate():Int
	{
