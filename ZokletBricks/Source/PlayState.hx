...
class PlayState extends FlxState 
{
	...
	/*[Embed(source = "../assets/black_brick.png")] protected var Bbrick:Class;
	[Embed(source = "../assets/yellow_brick.png")] protected var Ybrick:Class;
	[Embed(source = "../assets/paddle.png")] protected var PaddleImg:Class;
	[Embed(source = "../assets/ball.png")] protected var BallImg:Class;*/
