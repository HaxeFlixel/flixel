...
class DebuggerFrontEndTest
{
	...
	{
		testBoolSignal(
			function() return FlxG.debugger.drawDebug,
			function(b) FlxG.debugger.drawDebug = b,
			FlxG.debugger.drawDebugChanged
		);
	}
	...
	function testVisibilityChanged()
	{
		...
		testBoolSignal(
			function() return FlxG.debugger.visible,
			function(b) FlxG.debugger.visible = b,
			FlxG.debugger.visibilityChanged
		);
	}
