...
class GetStaticFieldsTest
{
	...
	static function get_test1() return 0;
	...
	static function get_test4() return 0;
	static function set_test4(i) return i;
	
	static var test5(never, set):Int;
	static function set_test5(i) return i;
...
class GetInstanceFieldsTest
{
	...
	function get_test4() return 0;
	function set_test4(i) return i;
	
	var test5(never, set):Int;
	function set_test5(i) return i;
