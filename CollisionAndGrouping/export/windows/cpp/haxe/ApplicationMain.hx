...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "CollisionAndGrouping", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "CollisionAndGrouping", null, { width: 400, height: 300 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 400, height: 300 });
			#end
