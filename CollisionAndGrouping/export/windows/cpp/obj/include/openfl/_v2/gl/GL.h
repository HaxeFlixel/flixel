...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		...
		static Void uniformMatrix2fv( Dynamic location,bool transpose,::openfl::_v2::utils::Float32Array v);
		static Dynamic uniformMatrix2fv_dyn();

		static Void uniformMatrix3fv( Dynamic location,bool transpose,::openfl::_v2::utils::Float32Array v);
		static Dynamic uniformMatrix3fv_dyn();

		static Void uniformMatrix4fv( Dynamic location,bool transpose,::openfl::_v2::utils::Float32Array v);
