...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/flixelLogo.png", __ASSET__assets_flixellogo_png);
		type.set ("assets/flixelLogo.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_flixellogo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/crate.png") class __ASSET__assets_crate_png extends lime.graphics.Image {}
@:bitmap("assets/elevator.png") class __ASSET__assets_elevator_png extends lime.graphics.Image {}
@:bitmap("assets/flixelLogo.png") class __ASSET__assets_flixellogo_png extends lime.graphics.Image {}
@:sound("D:/HaxeToolkit/haxe/lib/flixel/flixel/assets/sounds/beep.mp3") class __ASSET__assets_sounds_beep_mp3 extends lime.audio.AudioSource {}
@:sound("D:/HaxeToolkit/haxe/lib/flixel/flixel/assets/sounds/flixel.mp3") class __ASSET__assets_sounds_flixel_mp3 extends lime.audio.AudioSource {}
