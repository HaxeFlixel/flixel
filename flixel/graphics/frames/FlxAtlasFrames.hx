...
class FlxAtlasFrames extends FlxFramesCollection
{
	...
	{
		Frames.addAtlasFrame(FlxRect.get(FrameData.frame.x, FrameData.frame.y, FrameData.frame.w, FrameData.frame.h),
			FlxPoint.get(FrameData.spriteSourceSize.w, FrameData.spriteSourceSize.h),
			FlxPoint.get(FrameData.spriteSourceSize.x, FrameData.spriteSourceSize.y), FrameName, FlxFrameAngle.ANGLE_0, false, false);
	}
