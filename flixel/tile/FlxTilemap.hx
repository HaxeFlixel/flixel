...
class FlxTilemap extends FlxObject
{
	 ...
	 * @param	IgnoreXml		Whether to ignore any xml data generated by using the tiled map editor and exporting a csv.
	 * @return	A reference to this instance of FlxTilemap, for chaining as usual :)
	 */
	public function loadMap(MapData:Dynamic, TileGraphic:Dynamic, TileWidth:Int = 0, TileHeight:Int = 0, AutoTile:Int = 0, StartingIndex:Int = 0, DrawIndex:Int = 1, CollideIndex:Int = 1, IgnoreXml:Bool = true):FlxTilemap
	{
		auto = AutoTile;
