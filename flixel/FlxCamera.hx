 ...
 */
 ...
 class FlxCamera extends FlxBasic
 {
	 ...
	 * the bounds rectangle's edges. The deadzone's coordinates are measured from the camera's upper left corner in game pixels. For rapid prototyping, you can use the preset deadzones (e.g. PLATFORMER) with follow().
	 */
	 ...
	 * @param	Direction	Whether to FlxCameraShakeMode.SHAKE on both axes, just up and down, or just side to side (use class constants FlxCameraShakeMode.BOTH_AXES, FlxCameraShakeMode.VERTICAL_ONLY, or FlxCameraShakeMode.HORIZONTAL_ONLY).
	 */
