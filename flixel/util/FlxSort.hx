...
/**
 * Helper class for `FlxTypedGroup#sort()`, but could theoretically be used on regular arrays as well.
 */
class FlxSort
{
	...
	/**
	 * You can use this function in `FlxTypedGroup#sort()` to sort `FlxObject`s by their y-values.
	 */
