...
class CameraFrontEnd
{
	 ...
	 * @param	Direction	Whether to shake on both axes, just up and down, or just side to side (use FlxCameraShakeMode's class constants SHAKE_BOTH_AXES, SHAKE_VERTICAL_ONLY, or SHAKE_HORIZONTAL_ONLY).  Default value is SHAKE_BOTH_AXES (0).
	 */
