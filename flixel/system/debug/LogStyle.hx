...
class LogStyle
{
	...
	public static var WARNING:LogStyle = new LogStyle("[WARNING] ", "FFFF00", 12, true, false, false, FlxAssets.SND_BEEP, true);
	public static var ERROR:LogStyle = new LogStyle("[ERROR] ", "FF0000", 12, true, false, false, FlxAssets.SND_BEEP, true);
