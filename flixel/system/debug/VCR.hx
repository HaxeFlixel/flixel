...
class VCR
{
	...
	public function new()
	{
		...
		playbackToggleBtn = new FlxSystemButton(FlxAssets.getBitmapData(FlxAssets.IMG_PAUSE), onPause);
		...
		recordBtn = new FlxSystemButton(FlxAssets.getBitmapData(FlxAssets.IMG_RESTART), onRecord);
	...
	public function onPause():Void
	{
		...
		playbackToggleBtn.changeHandler(onPlay);
	}
	...
	public function onPlay():Void
	{
		...
		playbackToggleBtn.changeHandler(onPause);
	}
