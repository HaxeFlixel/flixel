...
class FlxPointer
{
	...
	var _globalScreenX:FlxAnalogInput<FlxAxes> = new FlxAnalogInput(FlxAxes.X, false);
	var _globalScreenY:FlxAnalogInput<FlxAxes> = new FlxAnalogInput(FlxAxes.Y, false);
