...
class FlxGamepadButtonList extends FlxBaseGamepadList
{
	...
	public var LEFT_STICK_CLICK (get, never):Bool; inline function get_LEFT_STICK_CLICK()  { return check(FlxGamepadButtonID.LEFT_STICK_CLICK);  }
	public var RIGHT_STICK_CLICK(get, never):Bool; inline function get_RIGHT_STICK_CLICK() { return check(FlxGamepadButtonID.RIGHT_STICK_CLICK); }
