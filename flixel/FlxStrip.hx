...
<<<<<<< HEAD
			camera.drawTriangles(graphic, vertices, indices, uvtData, colors, _point, blend, antialiasing, true);
=======
			camera.drawTriangles(graphic, vertices, indices, uvtData, colors, _point, blend, true, antialiasing);
>>>>>>> origin/dev
		}
	}
}